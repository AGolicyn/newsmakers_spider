...
LANGUAGE_MAPPER.update({}.fromkeys(settings['UK_NEWSPAPERS_URLS'], 'EN'))
...
GLOBAL_URLS.extend(settings['UK_NEWSPAPERS_URLS'])
...
COUNTRY_MAPPER.update({}.fromkeys(settings['UK_NEWSPAPERS_URLS'], 'UK'))
